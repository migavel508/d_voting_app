...
contract Create{
    ...
    function setCandidate(address _address ,string memory _age, string memory _name, string memory _image, string memory _ipfs) public {
        require(votingOrganizer==msg.sender,"only organizer can add a voters");
    ...
    function voterRight(address _address,string memory _name,string memory _image, string memory _ipfs) public {
         require(votingOrganizer==msg.sender,"only the organizer can create the voters");
    ...
    function vote(address _candidateAddress,uint256 _candidateVoted) external {
        Voter storage voter =voters[msg.sender];
        require(!voter.voter_voted,"you already voted");
        require(voter.voter_allowed!=0,"you have no right to vote");

        voter.voter_voted=true;
        voter.voter_vote=_candidateVoted;
